...
public class DataSourceForTest {
    public void setupDataSource(IDataTable dataTable) {
        ...
        List<IDataRow> dataRows = Arrays.asList(
                ...
                createDataRow("Aircraft", "Fighter", "MIG-17"),
                createDataRow("Aircraft", "Fighter", "MIG-19"),
                createDataRow("Aircraft", "Fighter", "MIG-21"),
                createDataRow("Aircraft", "Fighter", "MIG-23"),
                createDataRow("Aircraft", "Fighter", "MIG-25"),
                createDataRow("Aircraft", "Fighter", "MIG-29"),
                createDataRow("Aircraft", "Fighter", "UNKNOWN"),
